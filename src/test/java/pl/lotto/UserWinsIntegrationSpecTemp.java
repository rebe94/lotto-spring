...
public class UserWinsIntegrationSpecTemp {
    ...
    public void user_chooses_correct_numbers_and_receives_acceptance_and_hash_code_then_checks_result_and_receives_win_information() {
        ...
        /*try (MockedStatic<GameConfiguration> mocked = Mockito.mockStatic(GameConfiguration.class)) {
            mocked.when(GameConfiguration::nextDrawingDate).thenReturn(LocalDate.now());
        } *///TODO zmockować statyczną metodę, bo po godzinie zamknięcia losowania na dany dzień tj. 18:45 test nie przechodzi
        // when
